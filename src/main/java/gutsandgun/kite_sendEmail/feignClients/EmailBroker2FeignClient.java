...
@FeignClient(name = "emailFeignClient", url = "${feign.url.broker-dummy5}",contextId = "broker5" , configuration = FeignBrokerConfig.class)
public interface EmailBroker2FeignClient {
